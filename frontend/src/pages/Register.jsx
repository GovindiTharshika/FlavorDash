            ...
            <div className="w-full lg:w-1/2 flex flex-col px-6 md:px-12 lg:px-24 py-12 bg-surface">
                ...
                <div className="max-w-md w-full mx-auto flex flex-col justify-center flex-grow">
                    <div className="mb-10">
                        ...
                        <p className="font-body-md text-body-md text-on-surface-variant">Join FlavorDash to start your culinary journey.</p>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 mb-8">
                        <button onClick={async () => {
                                try {
                                    /* global google */
                                    const token = await window.google?.accounts?.id?.prompt();
                                } catch (e) {
                                    console.error(e);
                                }
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="w-full h-[56px] bg-primary-container text-white font-label-md text-label-md rounded-xl shadow-[0px_8px_24px_rgba(255,107,0,0.2)] hover:shadow-[0px_12px_32px_rgba(255,107,0,0.3)] transition-all duration-300 active:scale-[0.97] flex items-center justify-center gap-2 mt-4">
                            Create Account
