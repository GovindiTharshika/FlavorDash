    ...
    return (
        <div className="bg-background text-on-surface">
            <main className="pt-16 md:pt-20">
                {/* Hero Section */}
                <section className="relative min-h-[40vh] md:min-h-[50vh] lg:min-h-[600px] flex items-center overflow-hidden px-4 sm:px-6 md:px-10 lg:px-margin-desktop">
                    <div className="max-w-container-max mx-auto grid grid-cols-1 lg:grid-cols-2 gap-gutter items-center w-full z-10 py-8 lg:py-0">
                        <div className="space-y-stack-md md:space-y-stack-lg max-w-xl">
                            ...
                            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 pt-2 md:pt-4">
                                <Link
                                    to="/menu"
                                    className="bg-primary-container text-on-primary-container px-6 sm:px-8 py-3 sm:py-4 rounded-full font-label-md text-label-md hover:shadow-[0px_8px_24px_rgba(255,107,0,0.2)] transition-all active:scale-95 w-full sm:w-auto text-center"
                                >
                                    Order Now
                                </Link>
                                <Link
                                    to="/menu"
                                    className="border-2 border-on-surface text-on-surface px-6 sm:px-8 py-3 sm:py-4 rounded-full font-label-md text-label-md hover:bg-surface-container transition-all active:scale-95 w-full sm:w-auto text-center"
                                >
                                    View Menu
                                </Link>
                            </div>
                        ...
                        <div className="relative mt-6 lg:mt-0">
                            ...
                            <img className="relative z-10 w-full h-[200px] sm:h-[260px] lg:h-[420px] object-cover rounded-[24px] lg:rounded-[32px] shadow-2xl" alt="Gourmet Burger" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAJ0JW-0dpzndAxrNqOZYDsNTTJ1Ix9TmSdufZWuzgn3pQ6_RX8c0qF2GAOhlPUYz4ecA7Q63S94PGaPMVyt9xVnZ0aY-VIFC4sW6-uFhHrTEli8CQb8Cgt32qshcfPIZKXh_vuDqR2gVhNSepjnMF6_gcJw-BX0UabdKeffygLGi8WlYtjqa1TKXdPRLtyx1qyUVT6TwkHQQg4fWMYD6YtyyUh1TEPjAA4nwRtjqDPwLBD1yKjrRg-5rnwoiG1M7kcOEWdJwX9jIzl" />
                ...
                {/* Popular Categories */}
                <section className="py-2 md:py-5 bg-surface px-4 sm:px-6 md:px-10 lg:px-margin-desktop">
                    <div className="max-w-container-max mx-auto">
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 mb-8 md:mb-12">
                            ...
                            <Link to="/menu" className="text-primary font-label-md hover:underline flex items-center gap-2">
